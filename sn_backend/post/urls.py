...
urlpatterns = [
    ...
    path('group/your-group/',api.get_your_groups_post_list, name='get_your_groups_post_list'),
    path('group/<uuid:pk>/pending-posts/',api.get_pending_posts, name='get_pending_posts'),
    path('group/<uuid:pk>/pending-post/<uuid:id>/<str:status>/', api.handle_pending_post, name='handle_pending_post'),
    path('<uuid:pk>/', api.post_detail, name='post_detail'),
    path('page/<uuid:pk>/detail/', api.page_post_detail, name='page_post_detail'),
    path('group/<uuid:pk>/detail/', api.group_post_detail, name='group_post_detail'),
    ...
    path('group/<uuid:pk>/post/<uuid:id>/comment/', api.group_post_create_comment, name='group_post_create_comment'),
    ...
    path('group/<uuid:id>/poll/<uuid:pk>/add-option/', api.add_poll_option, name='add_poll_option'),
    path('group/<uuid:id>/poll/option/<uuid:pk>/vote/', api.vote_poll, name='vote_poll'),
    path('group/poll/option/<uuid:pk>/check-vote/', api.check_vote, name='check_vote'),
    path('group/<uuid:id>/post/<uuid:pk>/delete/', api.delete_group_post, name='delete_group_post'),
