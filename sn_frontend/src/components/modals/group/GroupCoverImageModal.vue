<template>
    <TransitionRoot @click="$emit('closeCoverImageModal')" appear as="template">
              ...
              >
                ...
                <div class="mt-4 flex justify-end gap-3">
                  <button
                    ...
                    @click="$emit('closeCoverImageModal')"
                  >
                    Hủy
                  </button>
                  <button
                    ...
                    @click="submitForm"
                    v-on:click="$emit('closeCoverImageModal')"
                  >
                    Đồng ý
                  </button>
                </div>
    ...
    methods: {
      ...
      submitForm() {
        ...
        if (this.errors.length === 0) {
          ...
          axios
            .post(`/api/group/${this.$route.params.id}/edit-cover-image/`, formData, {
              headers: {
                "Content-Type": "multipart/form-data",
              },
            })
            .then((res) => {
              if (res.data.message === "group cover image updated") {
                this.toastStore.showToast(
                  5000,
                  "Thay đổi ảnh bìa nhóm thành công.",
                ...
                this.toastStore.showToast(
                  5000,
                  "Thay đổi ảnh bìa nhóm thất bại.",
