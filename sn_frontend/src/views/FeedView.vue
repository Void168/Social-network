  ...
  <div class="max-w-7xl mx-auto grid grid-cols-4 gap-4">
    <div class="main-left col-span-1">
      <div class="p-4 bg-white border border-gray-200 text-center rounded-lg">
        ...
        />
        <p>
          <strong>Picking phone Tom</strong>
        </p>
    ...
    <div class="main-center col-span-2 space-y-4">
      <div class="p-4 bg-white border border-gray-200 rounded-lg">
        ...
        <div class="p-4 bg-white border border-gray-200 rounded-lg mt-8 mb-4">
          <div class="mb-6 flex items-center justify-between">
            <div class="flex items-center space-x-6">
              <img
                src="https://i.pinimg.com/736x/fa/81/55/fa81555d2190e9c91a7d584ce7174a5f.jpg"
            ...
            <p class="text-gray-600">28 phút trước</p>
          </div>
          ...
          <div class="my-6 flex justify-between">
            <div class="flex space-x-6">
              ...
              <div class="flex items-center space-x-2">
                ...
                <span class="text-gray-500 text-xs">3 bình luận</span>
              </div>
            </div>
        ...
        <div class="space-y-4">
          <div class="flex items-center justify-between">
            <div class="flex items-center space-x-2">
              ...
              <p class="text-xs"><strong>Picking phone Tom</strong></p>
            </div>

            <a href="#"><button class="btn-sm">Xem</button></a>
          </div>
