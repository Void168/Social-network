      ...
      <div class="flex items-start gap-3 w-full relative">
        <div class="group">
          <RouterLink
            :to="{
              name: 'profile',
              params: { id: comment?.created_by?.information?.id },
            }"
          >
            <img
          ...
          <TooltipProfile
            :user="comment?.created_by?.information"
        ...
        >
            ...
            <div class="flex items-center gap-1 group">
              <strong class="group">
                <RouterLink
                  ...
                  >{{ comment?.created_by?.information?.name }}</RouterLink
                >
                <TooltipProfile
                  :user="comment?.created_by?.information"
              ...
              <CommentDropDownVue
                v-if="
                  comment?.created_by?.information?.id === userStore.user.id &&
                  !pageStore.pageId
                "
          ...
          <p
            class="text-gray-600 dark:text-neutral-200 sm:text-base text-xs px-1"
          >
