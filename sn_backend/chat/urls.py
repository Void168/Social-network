...
urlpatterns = [
    ...
    path('page/<uuid:id>/', api.page_conversation_list, name='page_conversation_list'),
    ...
    path('page/<uuid:pk>/detail/', api.page_conversation_detail, name='page_conversation_detail'),
    ...
    path('send/page/<uuid:id>/', api.user_conversation_send_message_to_page, name='user_conversation_send_message_to_page'),
    path('page/<uuid:id>/send/<uuid:pk>/', api.page_conversation_send_message, name='page_conversation_send_message'),
    ...
    path('page/<uuid:pk>/set_seen/', api.user_set_seen_page_conversation, name='user_set_seen_page_conversation'),
    path('page/<uuid:id>/set_seen/<uuid:pk>/', api.page_set_seen_page_conversation, name='page_set_seen_page_conversation'),
