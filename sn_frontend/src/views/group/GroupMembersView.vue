        ...
        <div class="dark:bg-slate-700 rounded-lg p-4">
          <div>
            ...
            <h4 class="text-neutral-400">
              ...
              <strong
                class="dark:text-neutral-200 hover:underline cursor-pointer"
          ...
          <div>
            <h3 class="text-lg font-semibold">
              Thành viên ở gần bạn &middot; 10
            </h3>
            <div
              class="flex flex-col justify-between items-center px-4 py-2 gap-2"
            >
              <div
                v-for="n in 3"
                :key="n"
          ...
          <div>
            ...
            <h5 class="text-xs">
              ...
              đang xem trước nhóm. Bất kỳ người nào được mời và được phê duyệt
              đều có thể xem trước nội dung trong nhóm.
            </h5>
            <div
              class="flex flex-col justify-between items-center px-4 py-2 gap-2"
            >
