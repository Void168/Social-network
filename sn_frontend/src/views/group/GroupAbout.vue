          ...
          <div class="dark:bg-slate-700 rounded-lg p-4">
            ...
            <div class="flex gap-2" v-else>
              ...
              <div>
                ...
                <h5 class="text-sm">
                  Chỉ thành viên mới nhìn thấy mọi người trong nhóm và những gì
                  họ đăng.
                </h5>
              </div>
            </div>
            <div class="flex gap-2">
              <div
                class="flex flex-col justify-start py-1"
                v-if="group.show_group"
              >
                <EyeIcon class="w-6" />
              </div>
            ...
            <div class="flex gap-2">
              ...
              <div>
                ...
                <h5 class="text-sm">
                  ...
                  {{ group?.created_at?.slice(0, 4) }}. Lần gần nhất đổi tên là
                  vào 18 tháng 2, 2022.
