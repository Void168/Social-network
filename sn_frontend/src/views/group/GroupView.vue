<template>
  <div class="min-h-screen" :class="isExpand ? 'requires-no-scroll' : ''">
    ...
    <Suspense>
      ...
      <template #fallback><SkeletonLoadingContainer /></template>
    </Suspense>
...
import SkeletonLoadingDiscoverGroup from "../../components/loadings/SkeletonLoadingDiscoverGroup.vue";
import SkeletonLoadingContainer from "../../components/loadings/SkeletonLoadingContainer.vue";
import SkeletonLoadingYourGroup from '../../components/loadings/SkeletonLoadingYourGroup.vue';

import CreateGroupModal from "../../components/modals/group/createGroup/CreateGroupModal.vue";
import { ChevronLeftIcon, ChevronRightIcon } from "@heroicons/vue/20/solid";

const GroupPost = defineAsyncComponent({
  loader: () => import("../../components/items/group/post/GroupPost.vue"),
  loadingComponent: SkeletonLoadingPost,
  delay: 500,
  timeout: 3000,
});

const DiscoverGroup = defineAsyncComponent({
  loader: () => import("../../components/items/group/DiscoverGroup.vue"),
  loadingComponent: SkeletonLoadingDiscoverGroup,
  delay: 500,
  timeout: 3000,
});

const YourGroup = defineAsyncComponent({
  loader: () => import("../../components/items/group/YourGroup.vue"),
  loadingComponent: SkeletonLoadingYourGroup,
  delay: 500,
  timeout: 3000,
});
...
export default {
  ...
  components: {
    ...
    CreateGroupModal,
    SkeletonLoadingPost,
    SkeletonLoadingDiscoverGroup,
    SkeletonLoadingContainer,
    SkeletonLoadingYourGroup
  },
  setup() {
