...
urlpatterns = [
    ...
    path('check-request/<uuid:pk>/', api.check_request_in_group, name='check_request_in_group'),
    ...
    path('<uuid:pk>/join/cancel/', api.cancel_join_request_private_group, name='cancel_join_request_private_group'),
    ...
    path('<uuid:pk>/growth-members/', api.get_group_members, name='get_group_members'),
]